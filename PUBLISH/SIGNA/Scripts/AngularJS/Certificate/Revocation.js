app.controller('RevokeController', ['$scope', '$rootScope', '$http', '$filter', function (_s, _rs, _h, _f) {
    ...
    _s.Revoke = function (session, sessionKeys) {

        Swal.fire({
            title: "Revoke?",
            text: "Revoking your private key will immediately invalidate its use for authentication purposes, ensuring the security of your digital data and preventing unauthorized access to any sensitive information related to your private key.",
            icon: "warning",
            ...
            if (result.isConfirmed) {
                _h.post('../Certificate/RevokeUserKey', { _tUser: session, _tUserKey: sessionKeys }).then(function (c) {
                    if (c.data.message == 'Success') {
                        _s.session = c.data.session;
                        _s.sessionKeys = c.data.sessionKeys;
