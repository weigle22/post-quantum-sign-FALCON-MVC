...
your_dll.verifySignatureFromMemoryStream.argtypes = [ctypes.c_char_p, ctypes.c_char_p, ctypes.c_char_p, ctypes.c_uint]
...
def verify_signature_from_memory_stream(file_data, signature_str, public_key_str, logn):
    ...
    verification_result_str = your_dll.verifySignatureFromMemoryStream(file_data, signature_str.encode(), public_key_str.encode(), logn)
...
verification_result = verify_signature_from_memory_stream(file_data, signature_str, public_key_str, logn)
